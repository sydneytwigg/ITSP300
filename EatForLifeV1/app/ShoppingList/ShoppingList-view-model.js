...
/*
db.all("DROP TABLE IF exists itemList;\
CREATE temporary TABLE itemList (idItem varchar(7));\
INSERT INTO itemList VALUES ((SELECT idItem1 from list where idList = ?)), \
((SELECT idItem2 from list where idList = ?)),\
((SELECT idItem3 from list where idList = ?)),\
((SELECT idItem4 from list where idList = ?)),\
((SELECT idItem5 from list where idList = ?)),\
((SELECT idItem6 from list where idList = ?)),\
((SELECT idItem7 from list where idList = ?)),\
((SELECT idItem8 from list where idList = ?)),\
((SELECT idItem9 from list where idList = ?)),\
((SELECT idItem10 from list where idList = ?)),\
((SELECT idItem11 from list where idList = ?)),\
((SELECT idItem12 from list where idList = ?)),\
((SELECT idItem13 from list where idList = ?)),\
((SELECT idItem14 from list where idList = ?)),\
((SELECT idItem15 from list where idList = ?)),\
((SELECT idItem16 from list where idList = ?)),\
((SELECT idItem17 from list where idList = ?)),\
((SELECT idItem18 from list where idList = ?));\
\
INSERT INTO itemList VALUES ((SELECT idItem1 from list where idList = ?)), \
((SELECT idItem2 from list where idList = ?)),\
((SELECT idItem3 from list where idList = ?)),\
...
((SELECT idItem17 from list where idList = ?)),\
((SELECT idItem18 from list where idList = ?));\
SELECT Description, SUM(Grams) FROM item INNER JOIN itemList ON itemList.idItem = item.idItem GROUP BY Description;",[numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay1, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay2, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay3, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay4, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay5, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay6, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7, numDay7]).then(rows => {
            alert("Got here");
            rows.forEach((w) => {
            viewModel.countries.push({ 
                  name: rows[0], 
